...
class SpectrumMixin:
    ...
    def _on_spectrum_ready(self, name: str, freqs: np.ndarray, spectrum_db: np.ndarray) -> None:
        ...
        colors = [
            (0, 114, 178),    # Исходный — синий (стальной)
            (230, 57, 70),    # Красный
            (39, 164, 75),    # Зелёный
            (240, 165, 0),    # Оранжевый
    ...
    def _build_interactive_spectrum(
        ...
        # Цвета для методов — 9 различных, без белого и чёрного
        colors = [
            (230, 57, 70),    # Красный
            (39, 164, 75),    # Зелёный
            (240, 165, 0),    # Оранжевый
    ...
    def _build_qtchart_spectrum(
        ...
        # Цвета для графиков — 10 различных, без белого и чёрного
        colors = [
            QColor(0, 114, 178),   # Исходный — синий (стальной)
            QColor(230, 57, 70),   # Красный
            QColor(39, 164, 75),   # Зелёный
            QColor(240, 165, 0),   # Оранжевый
            QColor(148, 55, 183),  # Фиолетовый
            QColor(0, 168, 168),   # Бирюзовый
            QColor(220, 90, 150),  # Розовый
            QColor(130, 130, 30),  # Оливковый
            QColor(0, 180, 130),   # Мятный
            QColor(180, 100, 50),  # Коричневый
        ]
